...
float getVoxyIntegratedRainMaterialFactor(
    ...
    if (isPrecipitationRain <= 0.0 || geometricNormal.y < 0.005) {
        return 0.0;
    }
...
void voxy_emitFragment(VoxyFragmentParameters parameters) {
    ...
    #if COLOR_MODE == 0 || (defined WORLD_LIGHT && defined SHADOW_MAPPING) \
