...
/// -------------------------------- /// Vertex Shader /// -------------------------------- ///
        ...
        #if defined TERRAIN_ANIMATION || defined WATER_ANIMATION || defined WORLD_CURVATURE
        ...
        void main(){
            ...
            waterNoiseUv = vertexShdWorldPosXZ * waterTileSizeInv;
                ...
                vertexShdEyePlayerPos = getTerrainWave(vertexShdEyePlayerPos, vertexShdWorldPosXZ, at_midBlock.y * 0.015625, mc_Entity.x, lightMapCoord(gl_MultiTexCoord1.y), vertexFrameTime);
            #endif
